...
// Configures the MBR3 device with 128 bytes of Configuration data generated
// using Ez-Click over I2C/TWI. And reads data from an I2C/TWI slave
// device-CY8CMBR3116 and displays the status of the Capsense Buttons on the
...
void configureMBR3() {
  // Paste/Initialize the configuration array copied from the IIC file of
  // Ez-Click here under the configData array
  unsigned char configData[128] = {
      // Buzzer and Host Int Enabled: Jumper J15 in Configuration A on
      // CY3280-MBR3 Kit
      0x7Cu, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x7Fu, 0x7Fu, 0x80u, 0x80u, 0x80u, 0x80u, 0x80u, 0x7Fu,
      0x7Fu, 0x7Fu, 0x7Fu, 0x7Fu, 0x7Fu, 0x7Fu, 0x7Fu, 0x7Fu, 0x03u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x80u,
      0x05u, 0x00u, 0x00u, 0x02u, 0x00u, 0x02u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x81u, 0x01u, 0x00u, 0xFFu, 0xFFu, 0xFFu, 0xFFu, 0xFFu,
      0xFFu, 0xFFu, 0xFFu, 0x00u, 0x00u, 0x00u, 0x43u, 0x03u, 0x01u, 0x58u,
      0x00u, 0x37u, 0x06u, 0x00u, 0x00u, 0x0Au, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
      0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
  ...
  // Arduino function can send only 32 bytes at a time hence the ConfigData is
  // sent to MBR3 in chunks
  Wire.beginTransmission(SLAVE_ADDR); // transmit to device #0x37
  Wire.write(REGMAP_ORIGIN);          // sends Offset byte
